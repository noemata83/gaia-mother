<?php
/**
 * gaia-mother functions and definitions
 *
...
if ( ! function_exists( 'gaia_mother_setup' ) ) :
	/**
	 ...
	 */
	function gaia_mother_setup() {
		/*
		 * Make theme available for translation.
		 * Translations can be filed in the /languages/ directory.
		 * If you're building a theme based on gaia-mother, use a find and replace
		 * to change 'gaia-mother' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'gaia-mother', get_template_directory() . '/languages' );
		...
		register_nav_menus( array(
			'main_menu' => esc_html__( 'Primary', 'gaia-mother' ),
		) );
		...
		add_theme_support( 'custom-background', apply_filters( 'gaia_mother_custom_background_args', array(
...
add_action( 'after_setup_theme', 'gaia_mother_setup' );
 ...
 */
function gaia_mother_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'gaia_mother_content_width', 640 );
}
add_action( 'after_setup_theme', 'gaia_mother_content_width', 0 );
 ...
 */
function gaia_mother_widgets_init() {
	...
	register_sidebar( array(
		'name'          => __( 'Page Sidebar', 'gaia-mother' ),
		'id'            => 'page',
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
		'before_title'  => '<h2 class="widget-title">',
...
add_action( 'wp_enqueue_scripts', 'gaia_mother_scripts' );
...
function woo_init() {
	...
	remove_action( 'woocommerce_after_single_product_summary', array( 'WPEX_WooCommerce_Config', 'upsell_display' ), 15 );
